...
), 'GrLivArea' (Above grade (ground) living area square feet) and 'TotalBsmtSF' (Total square feet of basement area) are strongly correlated with 'SalePrice', which totally makes sense
